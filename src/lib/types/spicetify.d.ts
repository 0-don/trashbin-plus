declare namespace Spicetify {
  ...
  class URI {
     ...
     */ isSameIdentity(baseUri: URI | string, refUri: URI | string): boolean;
     ...
     */ albumURI(id: string, disc: number): URI;
     ...
     */ applicationURI(id: string, args: string[]): URI;
     ...
     */ collectionURI(username: string, category: string): URI;
     ...
     */ collectionAlbumURI(username: string, id: string): URI;
     ...
     */ localAlbumURI(artist: string, album: string): URI;
     ...
     */ localArtistURI(artist: string): URI;
     ...
     */ profileURI(username: string, args: string[]): URI;
     ...
     */ userToplistURI(username: string, toplist: string): URI;
    isAd(uri: URI | string): boolean;
    isAlbum(uri: URI | string): boolean;
    isGenre(uri: URI | string): boolean;
    isQueue(uri: URI | string): boolean;
    isApplication(uri: URI | string): boolean;
    isArtist(uri: URI | string): boolean;
    isArtistToplist(uri: URI | string): boolean;
    isArtistConcerts(uri: URI | string): boolean;
    isAudioFile(uri: URI | string): boolean;
    isCollection(uri: URI | string): boolean;
    isCollectionAlbum(uri: URI | string): boolean;
    isCollectionArtist(uri: URI | string): boolean;
    isCollectionMissingAlbum(uri: URI | string): boolean;
    isCollectionTrackList(uri: URI | string): boolean;
    isConcert(uri: URI | string): boolean;
    isContextGroup(uri: URI | string): boolean;
    isDailyMix(uri: URI | string): boolean;
    isEmpty(uri: URI | string): boolean;
    isEpisode(uri: URI | string): boolean;
    isFacebook(uri: URI | string): boolean;
    isFolder(uri: URI | string): boolean;
    isFollowers(uri: URI | string): boolean;
    isFollowing(uri: URI | string): boolean;
    isImage(uri: URI | string): boolean;
    isInbox(uri: URI | string): boolean;
    isInterruption(uri: URI | string): boolean;
    isLibrary(uri: URI | string): boolean;
    isLive(uri: URI | string): boolean;
    isRoom(uri: URI | string): boolean;
    isExpression(uri: URI | string): boolean;
    isLocal(uri: URI | string): boolean;
    isLocalTrack(uri: URI | string): boolean;
    isLocalAlbum(uri: URI | string): boolean;
    isLocalArtist(uri: URI | string): boolean;
    isMerch(uri: URI | string): boolean;
    isMosaic(uri: URI | string): boolean;
    isPlaylist(uri: URI | string): boolean;
    isPlaylistV2(uri: URI | string): boolean;
    isPrerelease(uri: URI | string): boolean;
    isProfile(uri: URI | string): boolean;
    isPublishedRootlist(uri: URI | string): boolean;
    isRadio(uri: URI | string): boolean;
    isRootlist(uri: URI | string): boolean;
    isSearch(uri: URI | string): boolean;
    isShow(uri: URI | string): boolean;
    isSocialSession(uri: URI | string): boolean;
    isSpecial(uri: URI | string): boolean;
    isStarred(uri: URI | string): boolean;
    isStation(uri: URI | string): boolean;
    isTempPlaylist(uri: URI | string): boolean;
    isToplist(uri: URI | string): boolean;
    isTrack(uri: URI | string): boolean;
    isTrackset(uri: URI | string): boolean;
    isUserToplist(uri: URI | string): boolean;
    isUserTopTracks(uri: URI | string): boolean;
    isUnknown(uri: URI | string): boolean;
    isMedia(uri: URI | string): boolean;
    isQuestion(uri: URI | string): boolean;
    isPoll(uri: URI | string): boolean;
    isPlaylistV1OrV2(uri: URI | string): boolean;
  }
  ...
  namespace ReactComponent {
    ...
    type ConfirmDialogProps = {
      ...
      allowHTML?: boolean;
      /**
       * Dialog title. Can be HTML if`allowHTML` is true
       */
      titleText: string;
      /**
  ...
  class Color {
    ...
    BLACK: Color;
    WHITE: Color;
    CSSFormat: Record<CSSColors, number> & Record<number, CSSColors>;
    ...
    fromHSL(hsl: hsl, alpha?: number): Color;
    fromHSV(hsv: hsv, alpha?: number): Color;
    fromRGB(rgb: rgb, alpha?: number): Color;
